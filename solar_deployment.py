...
Month=st.number_input("Month",["Month"].classes_)
Day=st.number_input("Day",["Day"].classes_)
First_Hour_of_Period=st.number_input("First Hour of Period",["First Hour of Period"].classes_)
